...
from l10n_parser import Comment, Entity, Junk, Whitespace, getParser
...
class TestDTD(ParserTestMixin, unittest.TestCase):
    ...
    def test_one_entity(self):
        ...
        self.assertListEqual([e.localized for e in self.parser], [True])
...
"""
    ...
    def test_trailing_whitespace(self):
        self._test(
            '<!ENTITY foo.label "stuff">\n  \n',
            (("foo.label", "stuff"), (Whitespace, "\n  \n")),
        )

    def test_unicode_comment(self):
        self._test(b"<!-- \xe5\x8f\x96 -->".decode("utf-8"), ((Comment, "\u53d6"),))
